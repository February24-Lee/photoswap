...
def load_512(image_path) -> np.ndarray:
...
class NullInversion:
    ...
    def invert(
        self, image_path: str, prompt: str, num_inner_steps=10, early_stop_epsilon=1e-5
    ):
        self.init_prompt(prompt)
        utils.register_attention_control(self.model, None)  # NOTE donald, what is this?
