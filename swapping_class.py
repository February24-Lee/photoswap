...
class LocalBlend:
    ...
    def __call__(self, x_t, attention_store):
        ...
        if self.counter > self.start_blend:
            ...
            maps = [
                item.reshape(self.alpha_layers.shape[0], -1, 1, 16, 16, 77)
                for item in maps
            ]
...
class AttentionControlEdit(abc.ABC):
    ...
    def __init__(
        ...
        self.cross_replace_alpha = utils.get_time_words_attention_alpha(
...
class AttentionSwap(AttentionControlEdit):
    ...
    def __init__(
        ...
        prompts,
        num_steps: int,
        cross_map_replace_steps: float,
        self_map_replace_steps: float,
        self_output_replace_steps: float,
        source_subject_word=None,
        target_subject_word=None,
        tokenizer=None,
        device=None,
        LOW_RESOURCE=False,
    ):
        ...
        super(AttentionSwap, self).__init__(
            prompts,
            num_steps,
